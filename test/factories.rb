  ...
  factory :event do
    ...
    factory :ordinary_event do
      after :create do |event, _evaluator|
        FactoryBot.create :oneliner_entry, event:
      end
    end
    ...
    factory :hidden_event do
      ...
      after :create do |event, _evaluator|
        FactoryBot.build :verbose_entry, event:
      end
    end
  end
  ...
  factory :radio_group, class: RadioGroup do
    ...
    factory :blue_man_group do
      ...
      factory :many_blue_men_group do
        after :create do |group, _eval|
          FactoryBot.create_list(:one_of_many_blue_radios, 42, radio_group: group)
        end
      end
    end
    ...
    factory :red_handed do
      ...
      factory :many_red_hands do
        after :create do |group, _eval|
          FactoryBot.create_list(:one_of_many_red_radios, 14, radio_group: group)
        end
      end
    end
  end
