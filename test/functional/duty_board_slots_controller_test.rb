...
class DutyBoardSlotsControllerTest < ActionController::TestCase
  ...
  test "should create duty_board_slot" do
    assert_difference('DutyBoardSlot.count') do
      post :create, { duty_board_slot: FactoryBot.attributes_for(:valid_duty_board_slot, duty_board_group_id: @duty_board_group.id) }, @user_session
    end
  ...
  test "should update duty_board_slot" do
    @duty_board_slot.save!
    put :update, { id: @duty_board_slot.to_param, duty_board_slot: FactoryBot.attributes_for(:valid_duty_board_slot) },
        @user_session
    assert_redirected_to duty_board_slots_path
  end
