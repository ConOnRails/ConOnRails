...
class DepartmentsControllerTest < ActionController::TestCase
  ...
  test "should create department" do
    assert_difference('Department.count') do
      post :create, { department: FactoryBot.attributes_for(:good_department, radio_group_id: @group.id) }, @user_session
    end
  ...
  test "should update department" do
    @valid_department.save!
    put :update, { id: @valid_department.to_param, department: FactoryBot.attributes_for(:good_department) }, @user_session
    assert_redirected_to department_path(assigns(:department))
  end
