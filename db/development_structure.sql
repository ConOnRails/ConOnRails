...
CREATE TABLE "event_flag_histories" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "event_id" integer, "is_active" boolean DEFAULT 'f', "comment" boolean DEFAULT 'f', "flagged" boolean DEFAULT 'f', "post_con" boolean DEFAULT 'f', "quote" boolean DEFAULT 'f', "sticky" boolean DEFAULT 'f', "emergency" boolean DEFAULT 'f', "medical" boolean DEFAULT 'f', "hidden" boolean DEFAULT 'f', "secure" boolean DEFAULT 'f', "consuite" boolean DEFAULT 'f', "hotel" boolean DEFAULT 'f', "parties" boolean DEFAULT 'f', "volunteers" boolean DEFAULT 'f', "dealers" boolean DEFAULT 'f', "dock" boolean DEFAULT 'f', "merchandise" boolean DEFAULT 'f', "created_at" datetime, "updated_at" datetime, "user_id" integer, "orig_time" datetime, "rolename" varchar(255));
