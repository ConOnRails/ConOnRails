...
ActiveRecord::Schema.define(version: 20140622210215) do
  ...
  create_table "audits", force: :cascade do |t|
    ...
    t.string   "auditable_type",  limit: 4000
    t.integer  "associated_id",   limit: 4
    t.string   "associated_type", limit: 4000
    t.integer  "user_id",         limit: 4
    t.string   "user_type",       limit: 4000
    t.string   "username",        limit: 4000
    t.string   "action",          limit: 4000
    t.text     "audited_changes", limit: 2147483647
    t.integer  "version",         limit: 4,          default: 0
    t.string   "comment",         limit: 4000
    t.string   "remote_address",  limit: 4000
  ...
  create_table "contacts", force: :cascade do |t|
    ...
    t.string   "cell_phone", limit: 4000
    t.string   "hotel",      limit: 4000
    t.integer  "hotel_room", limit: 4
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean  "can_text",                default: false
    t.string   "position",   limit: 4000
  end
  ...
  create_table "departments", force: :cascade do |t|
    ...
    t.integer  "radio_group_id",  limit: 4
    t.integer  "radio_allotment", limit: 4
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "duty_board_assignments", force: :cascade do |t|
    t.integer  "duty_board_slot_id", limit: 4
    t.string   "notes",              limit: 4000
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "name",               limit: 4000
    t.string   "string",             limit: 4000
  end
  ...
  create_table "duty_board_slots", force: :cascade do |t|
    t.string   "name",                limit: 4000
    t.integer  "duty_board_group_id", limit: 4
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.string   "merged_from_ids", limit: 4000
    t.boolean  "merged"
  ...
  create_table "lost_and_found_items", force: :cascade do |t|
    ...
    t.string   "where_last_seen", limit: 4000
    t.string   "where_found",     limit: 4000
    t.string   "owner_name",      limit: 4000
    t.text     "owner_contact",   limit: 2147483647
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "user_id",         limit: 4
    t.string   "rolename",        limit: 4000
    t.string   "who_claimed",     limit: 4000
  end

  create_table "messages", force: :cascade do |t|
    t.string   "for",          limit: 4000
    t.string   "phone_number", limit: 4000
    t.string   "room_number",  limit: 4000
    t.string   "hotel",        limit: 4000
    t.integer  "user_id",      limit: 4
  ...
  create_table "radios", force: :cascade do |t|
    t.string   "number",         limit: 4000
    t.string   "notes",          limit: 4000
    t.integer  "radio_group_id", limit: 4
    t.string   "image_filename", limit: 4000
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "state",          limit: 4000, default: "in"
  end
  ...
  create_table "taggings", force: :cascade do |t|
    ...
    t.string   "taggable_type", limit: 4000
    t.integer  "tagger_id",     limit: 4
    t.string   "tagger_type",   limit: 4000
  ...
  create_table "volunteers", force: :cascade do |t|
    ...
    t.string   "middle_name",              limit: 4000
    t.string   "last_name",                limit: 4000
    t.string   "address1",                 limit: 4000
    t.string   "address2",                 limit: 4000
    t.string   "address3",                 limit: 4000
    t.string   "city",                     limit: 4000
    t.string   "state",                    limit: 4000
    t.string   "postal",                   limit: 4000
    t.string   "country",                  limit: 4000
    t.string   "home_phone",               limit: 4000
    t.string   "work_phone",               limit: 4000
    t.string   "other_phone",              limit: 4000
