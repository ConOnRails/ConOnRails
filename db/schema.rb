...
ActiveRecord::Schema.define(version: 20_190_823_220_241) do
  ...
  create_table 'audits', force: :cascade do |t|
    ...
    t.index %w[associated_id associated_type], name: 'associated_index', using: :btree
    t.index %w[auditable_id auditable_type], name: 'auditable_index', using: :btree
  ...
  create_table 'duty_board_groups', force: :cascade do |t|
    ...
    t.index %w[row
               column], name: 'index_duty_board_groups_on_row_and_column', unique: true, using: :btree
  ...
  create_table 'roles_users', id: false, force: :cascade do |t|
    ...
    t.integer 'user_id'
    t.index %w[role_id
               user_id], name: 'index_roles_users_on_role_id_and_user_id', unique: true, using: :btree
  end
  ...
  create_table 'taggings', force: :cascade do |t|
    ...
    t.index %w[taggable_id taggable_type
               context], name: 'index_taggings_on_taggable_id_and_taggable_type_and_context', using: :btree
    t.index %w[taggable_id taggable_type tagger_id
               context], name: 'taggings_idy', using: :btree
    t.index ['taggable_id'], name: 'index_taggings_on_taggable_id', using: :btree
    t.index ['taggable_type'], name: 'index_taggings_on_taggable_type', using: :btree
    t.index %w[tagger_id
               tagger_type], name: 'index_taggings_on_tagger_id_and_tagger_type', using: :btree
